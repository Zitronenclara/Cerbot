...
const wert = 250000
const name = "Halbluzifer"
const roleid = "652841696781926410"

let buyhalbluzifer = function(mes) {
...
let sellhalbluzifer = function(mes) {
	con.query("SELECT id ,coins, coinsspent FROM userdata WHERE usrid = '"+mes.author.id+"'", function (err, result, fields) {
		if (err) throw err;
		if (mes.member.roles.has(roleid)){
			var aktucoins = result[0].coins;
...
exports.buyhalbluzifer = buyhalbluzifer;
exports.sellhalbluzifer = sellhalbluzifer;